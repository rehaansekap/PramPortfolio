...
export function MediaLightbox({
  ...
  return createPortal(
    ...
    >
      {/* Main Media Wrapper: Centers content and keeps title, count, and controls tightly attached */}
      <div
      ...
      >
        {/* Position & Caption HUD Badge: Positioned directly above the image frame */}
        <div className="flex items-center gap-2 mb-2.5 px-3.5 py-1 rounded-full bg-neutral-900/95 border border-white/20 backdrop-blur-md font-mono text-xs text-white/90 shadow-md self-center pointer-events-auto">
        ...
        {/* Bottom Hint: Directly beneath the image frame */}
