    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col sm:flex-row items-start gap-4">
        ...
        {value ? (
          ...
          >
            ...
            <button
              type="button"
              onClick={() => onChange("")}
              className="absolute top-1.5 right-1.5 p-1 rounded bg-bg-base/80 border border-border-subtle text-text-muted hover:text-text-primary transition-colors"
        ...
        <div className="flex flex-col gap-2 flex-grow">
          <label className="inline-flex items-center gap-2 px-4 py-2.5 rounded border border-border-subtle hover:border-border-hover bg-bg-base cursor-pointer font-mono text-xs text-text-primary transition-colors w-fit">
            {uploading ? (
              <>
          ...
          <input
            ...
            className="p-2.5 font-mono text-xs bg-bg-base border border-border-subtle rounded focus:outline-none focus:border-border-hover text-text-primary"
          />
