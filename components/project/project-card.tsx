...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Link
      ...
      className="group block rounded border border-border-subtle hover:border-border-hover bg-bg-elevated/40 hover:bg-bg-elevated/90 transition-all duration-300 overflow-hidden flex flex-col h-full hover:scale-[1.015] shadow-xs"
    >
